...
@dag(
    dag_id="retrain_the_model_mnist_784",
...
def processing_dag():
    ...
    def train_the_challenger_model():
        ...
        def load_the_train_test_data():
            X_train = wr.s3.read_csv("s3://data/final/train/mnist_784_X_train.csv")
            y_train = wr.s3.read_csv("s3://data/final/train/mnist_784_y_train.csv")
            X_test = wr.s3.read_csv("s3://data/final/test/mnist_784_X_test.csv")
            y_test = wr.s3.read_csv("s3://data/final/test/mnist_784_y_test.csv")
        ...
        def mlflow_track_experiment(model, X):
            ...
            mlflow.sklearn.log_model(
                ...
                registered_model_name="mnist_784",
